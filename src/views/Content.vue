        ...
        <div class="sec-a back" >
            <div class="sec-a-left">
                ...
                <div class="sec-a-text">
                    <h1>THE LARGEST INSPECTION COMPANY SERVING SOUTH FLORIDA <strong class="strong-red">SINCE 1993</strong></h1>
            ...
            <div class="wrap-sec-b-bottom">
                <div class="sec-b-bottom-left">
                    <div class="wrap-sec-b-text">
                        <div class="width-80">
                            <h2>Journey out of wreckage of Hurricane Andrew enters <strong class="strong-red"> 24th year of serving South Florida</strong></h2>
         ...
         <section class="sec-c">
             <div class="sec-c-top">
                ...
                <div class="sec-c-to-icons">
                    ...
                    <img src="./../assets/img/icons/icon2SecC.png" alt="">
                </div>
             </div>
...
<!-- SECTION-E -->
    ...
    <section class="sec-f">
        <div class="sec-f-top">
            <div class="sec-f-top-title">
                <h1>LICENSES</h1> 
            </div>
            <div class="sec-f-top-content">
        ...
        <div class="sec-f-bottom">
            <div class="sec-f-bottom-left">
                <div class="sec-f-layer"></div>
                <h1>TEAM WORK</h1>
            </div>
            <div class="sec-f-bottom-right">
    ...
    <section class="sec-contact">
        ...
        <div class="sec-contact-right">
          <div class="wrap-sec-contact-right">
